/**
 * Modified by lge to expose more control on the rendering process.
 * @author alteredq / http://alteredqualia.com/
 * @authod mrdoob / http://mrdoob.com/
 * @authod arodic / http://aleksandarrodic.com/
 * @authod fonserbc / http://fonserbc.github.io/
 * @authod lge / http://lige.me/
 *
...
var StereoEffect = function (renderer) {
  ...
  this.updateStereoCameras = function(camera) {
  ...
  this.enableScissorTest = function(flag) {
    renderer.enableScissorTest(flag);
  };

  // must called after updateStereoCameras
	this.renderToLeft = function(scene) {
  ...
  // must called after updateStereoCameras
	this.renderToRight = function(scene) {
  ...
  // must called after updateStereoCameras
  this.renderToStereo = function(scene) {
    this.renderToLeft(scene);
    this.renderToRight(scene);
  };

  /**
   * A possible render() implementation:
   */
  // function render() {
  ...
  //   effect.renderToLeft(scene);
  //   effect.renderToRight(scene);
